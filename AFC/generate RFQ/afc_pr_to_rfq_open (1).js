...
define(['N/ui/serverWidget', 'N/search', 'N/record', 'N/url', 'N/runtime', 'N/currency', 'N/error', 'N/config'],
  function(serverWidget, search, record, url, runtime, currency, error, config) {
    ...
    function onRequest(context) {
      ...
      var standartRfqForm = runtime.getCurrentScript().getParameter("custscript_afc_standart_rfq_form");
      var standartTenderForm = runtime.getCurrentScript().getParameter("custscript_afc_standart_tender_form");
      ...
      if (contextRequest.method == 'GET') {
        ...
        var customform = standartRfqForm;
        if (!is_rfq)
          customform = standartTenderForm;
