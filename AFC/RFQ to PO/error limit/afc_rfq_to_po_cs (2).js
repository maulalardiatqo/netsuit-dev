...
define(['N/search', 'N/currentRecord', 'N/query', 'N/record', 'N/format', 'N/ui/dialog', 'N/runtime'],
  function(search, currentRecord, query, record, format, dialog, runtime) {
    ...
    function validate(context, arrayToValidate) {
      ...
      if (RfqData.length > 0) {
        ...
        for (var z = 0; z < arrayToValidate; z++) {
          
          var detailID = arrayToValidate[z].detailID;
          var itemVal = arrayToValidate[z].itemVal;
          var itemDesc = arrayToValidate[z].itemDesc;
    ...
    function saveRecord(context) {
      ...
      for (var idx = 0; idx < count; idx++) {
        ...
        if (selectVal) {
          ...
          arrayToValidate.push({detailID, itemVal, itemDesc});
      ...
      var validateee = validate(context,arrayToValidate);
          if (!validateee) {
            let alert_cant_empty = {
              title: 'PO Link Validation',
              message: "RFQ Line has PO generated"
