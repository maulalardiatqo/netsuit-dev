...
define(["N/render", "N/search", "N/record", "N/log", "N/file", "N/http", 'N/config', 'N/format', 'N/email', 'N/runtime'],
  function(render, search, record, log, file, http, config, format, email, runtime) {
    function onRequest(context) {
      ...
      header += "<table class='tg' width=\"100%\"  style=\"border-bottom:1px;\">";
      header += "<tbody>";
      header += "<tr>";
      if (urlLogo) {
      ...
      body += "<table class='tg' width=\"100%\"  style=\"border-bottom:0px;\">";
      body += "<tbody>";
      //space
      body += "<tr>";
      ...
      body += "<table class='tg' width=\"100%\" style=\"border-bottom-1;\">";
      //1
      //space
      body += "<thead>";
      body += "<tr>";
