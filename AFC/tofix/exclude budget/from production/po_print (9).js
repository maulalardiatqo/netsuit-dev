...
define(["N/render", "N/search", "N/record", "N/log", "N/file", "N/http", 'N/config', 'N/format', 'N/email', 'N/runtime'],
  function(render, search, record, log, file, http, config, format, email, runtime) {
    function onRequest(context) {
      ...
      header += "<tr>";
      header += "<td class='tg-headerrow_bold_big_font' style='align:right;' colspan='4'>Purchase Order</td>";
      header += "</tr>";
      header += "</tbody>";
      header += "</table>";
      ...
      header += "<tbody>";
      header += "<tr colspan='4'>";
      header += "<td class='tg-noborder_12font'>Order From :</td>";
      header += "<td class='tg-noborder_12font'>Deliver and Invoice To :</td>"
      header += "<td class='tg-kolomnomorpo'>Purchase No.</td>"
      header += "<td class='tg-kolomdatapo'>" + tranid + "</td>"
      header += "</tr>";
      header += "<tr colspan='4'>";
      header += "<td class='tg-headerrow' >" + entityname + "</td>";
      header += "<td class='tg-headerrow' rowspan = '4'>" + poshipto + "</td>"
      header += "<td class='tg-kolomnomorpo'>PO Date</td>"
      header += "<td class='tg-kolomdatapo'>" + trandate + "</td>"
      header += "</tr>";
      header += "<tr>";
      header += "<td class='tg-headerrow' rowspan = '4'>" + billaddress + "</td>";
      header += "<td class='tg-kolomnomorpo'>PO Validity Date</td>"
      header += "<td class='tg-kolomdatapo'>"+ po_val_date +"</td>"
      header += "</tr>";
      header += "<tr>";
      header += "<td class='tg-kolomnomorpo'>Page</td>"
      header += "<td class='tg-kolomdatapo'>1</td>"
      header += "</tr>";
      header += "<tr>";
      header += "<td class='tg-kolomnomorpo'>Version</td>"
      header += "<td class='tg-kolomdatapo'>" + po_version + "</td>"
      header += "</tr>";
      header += "<tr>";
      header += "<td class='tg-noborder'></td>"
      header += "<td class='tg-kolomnomorpo'>Currency</td>"
      header += "<td class='tg-kolomdatapo'>" + currency + "</td>"
      header += "</tr>";
      header += "</tbody>";
      header += "</table>";
      ...
      body += "<table class='tg' width=\"100%\" height=\"80%\" style=\"border-bottom:1px\">";
      //1
      //space
      body += "<thead>";
      body += "<tr>";
...
//-5 original
      for (var index = 0; index < blankrow_cnt - 8; index++) {
        body += "<tr> ";
      ...
      body += "<tr>";
      body += "<td rowspan='4' class='tg-noborder' style='width:70%'><table>";
      body += "<tr>";
      body +=  "<td class='tg-noborder'>*</td>";
      body +=  "<td class='tg-noborder'>All official invoices shall have a PO number indicated or otherwise will be rejected.</td>";
      body += "</tr>";
      body += "<tr>";
      body += "<td class='tg-noborder'>*</td>";
      body += "<td class='tg-noborder'>All signed DO and Invoice must be submitted directly to Finance Department (financedept@the-afc.com)</td>";
      body += "</tr>";
      body += "<tr>";
      body += "<td class='tg-noborder'>*</td>";
      body += "<td class='tg-noborder'>Unless specifically stated otherwise, the attached terms and conditions shall form part of the Purchase Order.<br/>E. & O.E</td>";
      body += "</tr>"
      body += "<tr>";
      body += "<td class='tg-noborder'></td>";
      body += "<td class='tg-noborder'><b><i>This is a computer generated document, no signature required.</i></b></td>";
      body += "</tr>"
      body += "</table>" +
        "" +
        "</td>";

      body += "<td class='tg-noborder'></td>";//added margin here
      ...
      //9
      //body += "<table class='tg' width=\"100%\"  style=\"table-layout:fixed; margin-top: 10px;\">";
     // body += "<tbody>";
      //body += "<tr>";
     // body += "<td colspan='3' class='tg-noborder' style='text-align:center;'> <b><i>This is a computer generated document, no signature required.</i></b> </td>";
        ...
        try {
          if (vendor_email) {
            if (rqstEmail) {
              ...
              log.debug('enter else condition')
              var emailSend = email.send({
                author: currentuser,
                recipients: vendor_email,
                cc: [po_buyer || owner, ],
