      ...
      for (var i = 0; i < vendor_line_count; i++) {
        try {
          ...
          if (!isemailunawarded) {
            ...
            style += ".tg-body  {border-collapse:collapse;border-spacing:10;width:100%;}";
            ...
            style += ".tg-body tr:last-child {height:35%;}";
            ...
            style += ".tg-body .tg-headershipto{font-size:12px;font-weight: bold;align: center;}";
            ...
            header += "<tr>";
            header += "<td class='tg-headerlogo' style='width:17%;vertical-align:bottom;'><img src='" + urlLogo +
            ...
            //tabel
            body += "<tr >";
            body += "<td class='tg-headershipto' >No.</td>";
            body += "<td class='tg-headershipto' >Description</td>";
            body += "<td class='tg-headershipto' >quantity</td>"
            body += "<td class='tg-headershipto' >Unit Price<br/></td>"
            body += "<td class='tg-headershipto' >Total Price<br/></td>"
            body += "</tr>";
