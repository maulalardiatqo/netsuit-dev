...
define([
    ...
    try {
      ...
      if (typeof allPaymentData !== "undefined" && typeof vrecord !== "undefined") {
        for (var i in allPaymentData) {
          ...
          var balance = py.getValue(allPaymentDataSet.columns[py.columns.length -1]);
          console.log('nilai balance', balance)
          ...
          console.log('item no payment', item_no_payment)
          ...
          console.log('payble_payment', payable_payment);
          ...
          if (balance){
            vrecord.setCurrentSublistValue({
              sublistId: "custpage_sublist_out",
              fieldId: "sublist_out_trans_balance",
              value: balance,
              ignoreFieldChange: true,
            });
  ...
  function saveRecord(context) {
    ...
    console.log('Total transfer out', totaltransferout);
    var totaltransferin = rec.getValue('custpage_transtotal_in');
    console.log('Total transfer in', totaltransferin);
