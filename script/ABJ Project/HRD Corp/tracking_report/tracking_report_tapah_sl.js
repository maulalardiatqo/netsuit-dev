    ...
    if (contextRequest.method === "GET") {
      ...
      try {
        ...
        // load search budget
          ...
          data_budget = data_budget_set.getRange(0, 100);
        ...
        // load search PO
          ...
          data_po = data_po_set.getRange(0, 100);
        ...
        // data list budget
          ...
          data_budget.forEach(function (resultBudget) {
            ...
            var budget_amount = resultBudget.getValue({
              name: data_budget_set.columns[4],
            });
        ...
        if (datatranss.length <= 0) {
          ...
          xmlStr +=
            "<Table>" +
            "<Column ss:Index='1' ss:AutoFitWidth='0' ss:Width='156' />" +
          ...
          var list_project_expense = list_project.filter(function (item) {
            for (var key2 in filter_expense) {
              if (item[key2] === undefined || item[key2] != filter_expense[key2]) {
                return false;
              }
            }
            return true;
          ...
          xmlStr +=
            ...
            '<Cell ss:StyleID="S57"><Data ss:Type="String"></Data></Cell>' +
            '<Cell ss:StyleID="S57"><Data ss:Type="String"></Data></Cell>' +
            '<Cell ss:StyleID="S57NC"><Data ss:Type="Number"></Data></Cell>' +
            '<Cell ss:StyleID="S57NC"><Data ss:Type="Number"></Data></Cell>' +
            '<Cell ss:StyleID="S57NC"><Data ss:Type="String"></Data></Cell>' +
            '<Cell ss:StyleID="S57NC"><Data ss:Type="String"></Data></Cell>' +
            '<Cell ss:StyleID="S57NC"><Data ss:Type="String"></Data></Cell>' +
