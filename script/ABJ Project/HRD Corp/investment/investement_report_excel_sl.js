...
define([
  ...
  function onRequest(context) {
    ...
    if (contextRequest.method === "GET") {
      ...
      // RptFromDate.isMandatory = true;

      // var RptToDate = form.addField({
      // id: 'rpt_to_date',
      // type: serverWidget.FieldType.DATE,
      // label: 'TO DATE',
      // container: 'filteroption',
      ...
      try {
        ...
        if (list_investment.length <= 0) {
          ...
          list_investment.forEach((data, index) => {
            ...
            xmlStr +=
              "<Row>" +
              '<Cell ss:StyleID="NB"><Data ss:Type="String">' + data.labelSummary + '</Data></Cell>' +
              '<Cell ss:StyleID="NBN"><Data ss:Type="Number">' + data.atCost + '</Data></Cell>' +
              '<Cell ss:StyleID="NBN"><Data ss:Type="Number">' + data.atMarketValue + '</Data></Cell>' +
              '<Cell ss:StyleID="NBN"><Data ss:Type="Number">' + data.incomeEarned + '</Data></Cell>' +
              '<Cell ss:StyleID="NBN"><Data ss:Type="Number">' + data.accrualincome + '</Data></Cell>' +
              '<Cell ss:StyleID="NBN"><Data ss:Type="Number">' + roi + '</Data></Cell>' +
          ...
          xmlStr +=
            ...
            '<Cell ss:StyleID="BNCN"><Data ss:Type="Number">' + at_cost_total + '</Data></Cell>' +
            '<Cell ss:StyleID="BNCN"><Data ss:Type="Number">' + at_market_value_total + '</Data></Cell>' +
            '<Cell ss:StyleID="BNCN"><Data ss:Type="Number">' + income_earned_total + '</Data></Cell>' +
            '<Cell ss:StyleID="BNCN"><Data ss:Type="Number">' + accrual_income_total + '</Data></Cell>' +
            '<Cell ss:StyleID="BNCN"><Data ss:Type="Number">' + avgRoi + '</Data></Cell>' +
            '<Cell ss:StyleID="BNCN"><Data ss:Type="Number">' + percenTotal + '</Data></Cell>' +
            "</Row>";
          // End Footer
