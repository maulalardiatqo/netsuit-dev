  ...
  function afterSubmit(context) {
    try {
      ...
      if (isEdit) {
        ...
        var vdrNumbering = vendorRec.getValue('custentity_abj_vdr_numbering');
        ...
        log.debug("vdrNumbering", vdrNumbering);
      }
      ...
      if (isInsert || (isEdit && ((oldvdrGroup !== vdrGroup) || (vdrTextOld != vdrText) || (!vdrEntityIdOldText.includes("-"))))) {
        if (vdrGroup == 1) {
        ...
        if (isEdit && vdrNumbering.includes("-")) {
          var vdrNumberingUpdate = vdrNumbering.split("-");
          var vdrNumberingUpdateID = vdrNumberingUpdate[0].trim();
          var vdrNumberingUpdateNow = vdrNumberingUpdateID + " - " + vdrCompName;
          log.debug("data", {
            vdrNumberingUpdateID: vdrNumberingUpdateID,
            vdrNumberingUpdateNow: vdrNumberingUpdateNow
          });
          vendorRec.setValue({
            fieldId: 'entityid',
            value: vdrNumberingUpdateNow,
            ignoreFieldChange: true
          });
