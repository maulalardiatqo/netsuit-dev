  ...
  function afterSubmit(context) {
    try {
      if (context.type == context.UserEventType.CREATE || context.type == context.UserEventType.EDIT) {
        ...
        log.debug("vdrEntityIDText", vdrEntityIDText);
        ...
        if (vdrGroup == 1) {
          ...
          vendorRunningNumbers.forEach(function(vendorRunningNumber) {
            ...
            if ((vdrEntityIDText.charAt(0) != "P" && vdrEntityIDText.charAt(0) != "F" && !vdrEntityIDText.includes("-")) || (!vdrEntityIDText.includes("-")) || (!vID.includes(prefixNumber))) {
