...
define(['N/ui/serverWidget', 'N/search', 'N/runtime'], (ui, search, runtime) => {
    ...
    const onRequest = (context) => {
        if (context.request.method === 'GET') {
            const form = ui.createForm({ title: 'Print RFQ Response' });

            const rfqField = form.addField({
                id: 'custpage_rfq_res_select',
                type: ui.FieldType.SELECT,
                label: 'Select RFQ Response Number',
                source : 'vendorrequestforquote'
            });
            ...
            // === SET CLIENT SCRIPT ===
            form.clientScriptModulePath = "SuiteScripts/abj_cs_rfq_res_print.js";
