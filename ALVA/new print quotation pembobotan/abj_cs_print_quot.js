...
define(["N/currentRecord", "N/search", "N/url"], function (currentRecord, search, url) {
  ...
  function printPDFV2() {
    ...
    console.log("id", id);
    console.log("urlpdf", createPDFURL);
    createPDFURL += "&version=v2&id=" + id;
    if (createPDFURL) {
      newWindow = window.open(createPDFURL);
    }
  }
  function printPDFV2a() {
    var id = currentRecordObj.id;
    var createPDFURL = url.resolveScript({
      scriptId: "customscript_abj_sl_print_qout_new",
      deploymentId: "customdeploy_abj_sl_print_qout_new",
      returnExternalUrl: false,
    });
    console.log("id", id);
    console.log("urlpdf", createPDFURL);
  ...
  exports.printPDFV2 = printPDFV2;
  exports.sendMail = sendMail;
  exports.printPDFV2a = printPDFV2a;
  return exports;
});
