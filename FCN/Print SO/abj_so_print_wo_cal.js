    ...
    function onRequest(context) {
      ...
      // PO data
        ...
        if (amountRecieved) {
            ...
            amountRecieved = removeDecimalFormat(amountRecieved)
        }
        ...
        if (itemCount > 0) {
            ...
            amountTotal = pembulatan(amountTotal)
            if (amount) {
                amount = pembulatan(amount)
            ...
            if (amountTotal) {
                ...
                amountTotal = removeDecimalFormat(amountTotal)
            }
            if (taxAmt) {
            ...
            body += "<td class='tg-b_body' style='align:right;'>" + amountTotal + "</td>";
            body += "</tr>";
            }
            return body;
        }
