    ...
    function(render, search, record, log, file, http, config, format, email, runtime) {
        ...
        function onRequest(context) {
            ...
            if(subsidiari){
                ...
                log.debug('ddresSubsidiaries before',addresSubsidiaries)
            ...
            log.debug('addres msubsidiari', addresSubsidiaries)
            // load vendor
            ...
            var total = invoiceRecord.getValue('total') || 0;
            var amountReceive = invoiceRecord.getValue('total') || 0;
