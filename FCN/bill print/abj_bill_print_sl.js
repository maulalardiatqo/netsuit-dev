                ...
                for (var i = 0; i < countItem; i++) {
                    ...
                    if(account){
                        ...
                        var searchItem = search.create({
                            ...
                            var searchItemSet = searchItem.run();
                            searchItem = searchItemSet.getRange({
                                start: 0,
                                end: 1,
                            });
                        if(searchItem.length > 0){
                            var itemRecord = searchItem[0];
                            var expAccount = itemRecord.getValue('expenseaccount');
                            var accountItem = record.load({
                                type : 'account',
                                id : expAccount,
                                isDynamic: false,
                            });
                            cekWH = accountItem.getValue('custrecord_coa_wh');
                        }else{
                            ...
                            var expAccountDis = recItem.getValue('account');
                            var loadAccount = record.load({
                                type : 'account',
                                id : expAccountDis,
                                isDynamic: false,
                            });
                            cekWH = loadAccount.getValue('custrecord_coa_wh')
                        }
                        if(cekWH === false){
