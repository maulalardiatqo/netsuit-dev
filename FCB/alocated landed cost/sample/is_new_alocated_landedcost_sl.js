...
define([
  ...
  function onRequest(context) {
    ...
    if (contextRequest.method === "GET") {
      ...
      let linkToSaveSearch = `https://6865308.app.netsuite.com/app/common/search/searchresults.nl?rectype=392&searchtype=Custom&CUSTRECORD_INBOUND_SHIPMENT=${ibIDform}&style=NORMAL&report=&grid=&searchid=890&dle=F&sortcol=Custom_NAME_raw&sortdir=ASC&csv=HTML&OfficeXML=F&pdf=&size=50&_csrf=SVhsOuFz6K-wTgH56ntJCI8p7tq73pGkXHYFJlFsrvRzoqs2r9cagUhNCPWN8UDa3QsVtj-SZmzNO1dI9RyQEk7KzuVqoRBX4MpRWni8ZKJcw9Wqo_QIC67fEKKOr73r9eiZCPQijuLd_N4BwB7U49WELA6rLR7RMPA0J0p90zE%3D&twbx=F`;
      html +=
        '<input style="border: none; color: rgb(255, 255, 255); padding: 8px 30px; margin-top: 15px; cursor: pointer; text-align: center; background-color: rgb(0, 106, 255); border-color: rgb(0, 106, 255); fill: rgb(255, 255, 255); border-radius: 3px; font-weight: bold; font-size:12px;" type="button" onclick="window.history.go(-2)" value="Back" /><a href=' + linkToSaveSearch + ' target="_blank" style="text-decoration: none; margin-left: 10px; border: none; color: rgb(255, 255, 255); padding: 8px 30px; margin-top: 15px; cursor: pointer; text-align: center; background-color: rgb(0, 106, 255); border-color: rgb(0, 106, 255); fill: rgb(255, 255, 255); border-radius: 3px; font-weight: bold; font-size:12px;">See Result</a>';

      html += "</body></html>";

      var form = serverWidget.createForm({
        title: "Allocating Landed Cost",
      });
