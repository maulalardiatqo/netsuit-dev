    ...
    function (render, search, record, log, file, http, config, format, email, runtime) {
        ...
        function getData(context, allData) {
            ...
            allData.forEach((data) => {
                ...
                body += "<td style='align:left; font-size:10px; border: 1px solid black; border-right:none;'>" + custName + "</td>";
                body += "<td style='align:left; font-size:10px; border: 1px solid black; border-right:none;'>" + itemName + "</td>";
                ...
                body += "<td style='align:left; font-size:10px; border: 1px solid black; '>" + ket + "</td>";
                body += "</tr>";
                No++
            })
            return body;
