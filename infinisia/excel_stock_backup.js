...
define(["N/ui/serverWidget", "N/render", "N/search", "N/record", "N/log", "N/file", "N/http", "N/config", "N/format", "N/email", "N/runtime", "N/currency", "N/encode"], function (serverWidget, render, search, record, log, file, http, config, format, email, runtime, currency, encode) {
    ...
    function onRequest(context) {
      ...
      if (contextRequest.method == "GET") {
        ...
        log.debug('groupedByEmployeeName', groupedByEmployeeName)
        ...
        if (dataEmployee) {
          var trimmedResult = dataEmployee.substring(0, dataEmployee.length - 1);
        }
        xmlStr +=
          "<Table>" +
          ...
          '" ss:StyleID="OAC"><Data ss:Type="String">STOK BARANG</Data></Cell>' +
        ...
        xmlStr += '<Cell ss:StyleID="OAC"><Data ss:Type="String">Price / KG (USD)</Data></Cell>';
        xmlStr += '<Cell ss:StyleID="OAC"><Data ss:Type="String">Total Price (USD)</Data></Cell>';
        xmlStr += '<Cell ss:StyleID="OAC"><Data ss:Type="String">Total Price (IDR)</Data></Cell>';
        xmlStr += '<Cell ss:StyleID="OAC"><Data ss:Type="String"><=30</Data></Cell>';
        xmlStr += '<Cell ss:StyleID="OAC"><Data ss:Type="String">30-60</Data></Cell>';
        xmlStr += '<Cell ss:StyleID="OAC"><Data ss:Type="String">61-90</Data></Cell>';
        xmlStr += '<Cell ss:StyleID="OAC"><Data ss:Type="String">91-120</Data></Cell>';
        xmlStr += '<Cell ss:StyleID="OAC"><Data ss:Type="String">>120</Data></Cell>';
        xmlStr += "</Row>";
