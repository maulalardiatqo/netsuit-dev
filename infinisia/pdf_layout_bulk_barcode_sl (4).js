        ...
        <table height="28mm" width="33mm">
            <tr>
                <td style="padding-top: 2mm;">
                    <barcode style="padding-bottom: 0; margin-bottom:0;" bar-width="1" height="20" codetype="code128" showtext="false" value="${internalid}" />
                    ...
                    <span style="font-size: 4pt;">W.H : ${location} - ${binNumber}</span><br/>
