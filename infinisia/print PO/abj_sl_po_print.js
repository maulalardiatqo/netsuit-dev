    ...
    function(render, search, record, log, file, http, config, format, email, runtime) {
        try{
            ...
            function onRequest(context) {
                ...
                body += "<tr>";
                body += "<td style='font-size:14px; font-weight: bold; color:#0B3383; align:center'>PURCHASE ORDER</td>"
                body += "</tr>"

                body += "<tr>";
                body += "<td style='font-size:12px; color:#0B3383; align:center'>(CUSTOMER)</td>"
                body += "</tr>"
                ...
                body += "<td>:</td>"
                body += "<td>"+poDate+"</td>"
                body += "<td style='font-weight:bold'>MANUAL PO FOR :</td>"
                ...
                body+= "<td class='tg-head_body' style='width:9%; border: 1px solid black; border-right:none;'> UOM </td>"
                body+= "<td class='tg-head_body' style='width:21%; border: 1px solid black; border-right:none;'> DESCRIPTION </td>"
                body+= "<td class='tg-head_body' style='width:12%; border: 1px solid black; border-right:none;'> UNIT PRICE ($) </td>"
