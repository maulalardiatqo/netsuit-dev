...
define(["N/render", "N/search", "N/record", "N/log", "N/file", "N/http", 'N/config', 'N/format', 'N/email', 'N/runtime'],
    function(render, search, record, log, file, http, config, format, email, runtime) {
        ...
        function onRequest(context) {
            ...
            body += "<tr>";
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'> NO </td>"
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'> INVENTORY CODE </td>"
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'> INVENTORY NAME </td>"
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'> CURRENT STOCK </td>"
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'> INCOMING STOCK </td>"
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'> OS.PO </td>"
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'> BUFFER</td>"
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'> TOTAL ORDER </td>"
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'>PACKING SIZE </td>"
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'>JUMLAH PACKING</td>"
             body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; border-right:none; align:center'>TANGGAL KIRIM</td>"
            body += "<td class='tg-head_body' style='background-color:#4DA1D2FF; vertical-align:center; align:center'> NOTE </td>"
            body += "</tr>";
            ...
            body += "<table class='tg' width=\"100%\" style=\"table-layout:fixed;font-size:5px;\">";
            body += "<tbody>";
            body += "<tr>"
            body += "<td style='width:2.976%'></td>"
            body += "<td style='width:0.595%'></td>"
            body += "<td style='width:10.148%'></td>"
            body += "<td style='width:0.595%'></td>"
            body += "<td style='width:2.976%'></td>"
            body += "<td style='width:0.595%'></td>"
            body += "<td style='width:10.148%'></td>"
            ...
            body += "</tr>";
            body += "<tr>"
            body += "<td style='height:40px' colspan='28'></td>"
            body += "</tr>";

            body += "<tr>"
            body += "<td style=''></td>"
            body += "<td style=''>(</td>"
            body += "<td style='align:center;'>ADMIN BUSDEV</td>"
            body += "<td style=''>}</td>"
            body += "<td style=''></td>"
            body += "<td style=''>(</td>"
            body += "<td style='align:center;'>BUSDEV</td>"
            body += "<td style=''>}</td>"
            body += "<td style=''></td>"
            body += "<td style=''>(</td>"
            body += "<td style='align:center;'>FINANCE AR</td>"
            body += "<td style=''>}</td>"
            body += "<td style=''></td>"
            body += "<td style=''>(</td>"
        ...
        function generateTableHTML(itemId, dataItem, nomor) {
            ...
            let html = `<tr>
                ...
                <td class='tg-b_body' style="border-right: 1px solid black; border-right:none;">${firstItem.packingSize}</td>
                <td class='tg-b_body' style="border-right: 1px solid black; border-right:none;">${firstItem.totalOrder}</td>
        ...
        function getPOItem(context, recid){
            ...
            if(itemCount.length > 0){
                ...
                for(var index = 0; index < itemCount.length; index++){
                    ...
                    var packingSize = poRecord.getText({
                        name: "custrecord_iss_pack_size",
                        join: "CUSTRECORD_ISS_PR_PARENT",
                    });
                    var totalOrder = poRecord.getValue({
                        name: "formulatext",
                        formula: "{CUSTRECORD_ISS_PR_PARENT.custrecord_iss_total_order_formula}",
                    })||0;
                    log.debug('data', {totalOrder : totalOrder, tglKirim : tglKirim})
                    dataItem.push({
                        itemId : itemId,
                        itemText : itemText,
