 ...
 * **Copyright (c) 2025 ABJ Cloud Solutions, Inc.
 * @Client        :  Suy Sing
 * @Script Name   :  - SSCC | RL | Get Account Format
 * @script File   :  abj_rl_get_account_format.js
 * @Trigger Type  :  Get Account Format
    ...
    */
    function get(requestParams) {
        try{
            ...
            var accountFormatSearch = search.load({
                id: 'customsearchwebsite_account_format_get'
            });

            var pagedData = accountFormatSearch.runPaged({
                pageSize: pageSize
            });
            ...
            page.data.forEach(function (result) {
                var formatData = result.getValue({
                    name: 'custentity_abj_format'
                });

                var formatDesc = result.getValue({
                    name: 'custentity_abj_cust_formatdescription'
                });
