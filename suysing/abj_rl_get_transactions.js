 ...
 * **Copyright (c) 2025 ABJ Cloud Solutions, Inc.
 * @Client        :  Suy Sing
 * @Script Name   :  - SSCC | RL | Get Transactions
 * @script File   :  abj_rl_get_transactions.js
    ...
    */
    function get(requestParams) {
        try{
            ...
            var transactionsSearch = search.load({
                id: 'customsearchwebsite_transactions_get'
            });
            var pagedData = transactionsSearch.runPaged({
                pageSize: pageSize
            });
            ...
            page.data.forEach(function (result) {
                ...
                var itemMainBoard = result.getValue({
                ...
                var stauts = result.getValue({
                    name: "statusref"
                });
                
                results.push({
                    customerName: customerName || '',
                    itemMainBoard : itemMainBoard || '',
                    memo : memo || '',
                    stauts : stauts || ''
                });
            });
