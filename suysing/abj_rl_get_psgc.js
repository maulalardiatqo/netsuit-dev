 ...
 * **Copyright (c) 2025 ABJ Cloud Solutions, Inc.
 * @Client        :  Suy Sing
 * @Script Name   :  - SSCC | RL | Get PSGC
 * @script File   :  abj_rl_get_psgc.js
    ...
    */
    function get(requestParams) {
        try{
            ...
            var psgcSearch = search.load({
                id: 'customsearchwebsite_account_psgc_get'
            });

            var pagedData = psgcSearch.runPaged({
                pageSize: pageSize
            });
            ...
            page.data.forEach(function (result) {
                var psgcName = result.getValue({
                    name: 'name'
                });

                var psgcCode = result.getValue({
                    name: 'custrecord_abj_psgccode_psgc'
                });
