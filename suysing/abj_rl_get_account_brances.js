 ...
 * **Copyright (c) 2025 ABJ Cloud Solutions, Inc.
 * @Client        :  Suy Sing
 * @Script Name   :  - SSCC | RL | Get BRANCHES
 * @script File   :  abj_rl_get_account_brances.js
    ...
    */
    function get(requestParams) {
        try{
            ...
            var brancesSearcch = search.load({
                id: 'customsearch1817'
            });

            var pagedData = brancesSearcch.runPaged({
                pageSize: pageSize
            });
            ...
            page.data.forEach(function (result) {
                var branchId = result.getValue({
                    name: 'custrecord_5826_loc_branch_id'
                });
                var branchName = result.getValue({
                    name: 'name'
                });
                var psgc = result.getValue({
                    name: 'custrecord_abj_loc_psgc'
                });
