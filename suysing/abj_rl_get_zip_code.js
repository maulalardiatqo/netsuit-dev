 ...
 * **Copyright (c) 2025 ABJ Cloud Solutions, Inc.
 * @Client        :  Suy Sing
 * @Script Name   :  - SSCC | RL | Get ZIP Code
 * @script File   :  abj_rl_get_zip_code.js
    ...
    */
    function get(requestParams) {
        try{
            ...
            var zipCodeSearch = search.load({
                id: 'customsearchwebsite_account_zipcodes_get'
            });

            var pagedData = zipCodeSearch.runPaged({
                pageSize: pageSize
            });
