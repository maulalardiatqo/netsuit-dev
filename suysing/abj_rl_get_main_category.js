 ...
 * **Copyright (c) 2025 ABJ Cloud Solutions, Inc.
 * @Client        :  Suy Sing
 * @Script Name   :  - SSCC | RL | Get Main Category
 * @script File   :  abj_rl_get_main_category.js
    ...
    */
    function get(requestParams) {
        try{
            ...
            var mainCategorySearch = search.load({
                id: 'customsearchwebsite_main_category_get'
            });

            var pagedData = mainCategorySearch.runPaged({
                pageSize: pageSize
            });
