 ...
 * **Copyright (c) 2025 ABJ Cloud Solutions, Inc.
 * @Client        :  Suy Sing
 * @Script Name   :  - SSCC | RL | Get Lead Sources
 * @script File   :  abj_rl_get_lead_source.js
    ...
    */
    function get(requestParams) {
        try{
            ...
            var leadSouce = search.load({
                id: 'customsearchwebsite_account_lead_get'
            });

            var pagedData = leadSouce.runPaged({
                pageSize: pageSize
            });
            ...
            page.data.forEach(function (result) {
                var leadDate = result.getValue({
                    name: 'leaddate'
                });

                var leadSource = result.getValue({
                    name: 'leadsource'
                });
                var leadStatus = result.getValue({
                    name: 'entitystatus'
                });
