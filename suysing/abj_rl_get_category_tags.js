 ...
 * **Copyright (c) 2025 ABJ Cloud Solutions, Inc.
 * @Client        :  Suy Sing
 * @Script Name   :  - SSCC | RL | Get Category Tags
 * @script File   :  abj_rl_get_category_tags.js
    ...
    */
    function get(requestParams) {
        try{
            ...
            var categoryTagsSearch = search.load({
                id: 'customsearchwebsite_category_tags_get'
            });

            var pagedData = categoryTagsSearch.runPaged({
                pageSize: pageSize
            });
