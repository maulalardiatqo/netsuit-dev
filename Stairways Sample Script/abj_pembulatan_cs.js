...
define(['N/currentRecord'], function (currentRecord) {
    ...
    function updateAllLines(currentRecordObj, countLine) {
        for (var i = 0; i < countLine; i++) {
            currentRecordObj.selectLine({ sublistId: 'price5', line: i });

            var price_1 = currentRecordObj.getCurrentSublistValue({ sublistId: 'price5', fieldId: 'price_1_' });
            var price_2 = currentRecordObj.getCurrentSublistValue({ sublistId: 'price5', fieldId: 'price_2_' });
            var price_3 = currentRecordObj.getCurrentSublistValue({ sublistId: 'price5', fieldId: 'price_3_' });
            var price_4 = currentRecordObj.getCurrentSublistValue({ sublistId: 'price5', fieldId: 'price_4_' });
            var price_5 = currentRecordObj.getCurrentSublistValue({ sublistId: 'price5', fieldId: 'price_5_' });
            ...
            currentRecordObj.commitLine({ sublistId: 'price5' });
        }
    }
