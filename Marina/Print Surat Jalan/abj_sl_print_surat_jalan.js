    ...
    function onRequest(context) {
        try{
            ...
            if(soId){
                ...
                jatuhTempo = recSo.getValue('terms');
            ...
            xml += 'body {font-family: sans-serif; width: 279.4mm; height: 241.3mm;}';
            xml += 'table {border-collapse: collapse;}'; 
            xml += 'td {padding: 0; vertical-align: middle;}'; 
            xml += '</style>';
            xml += '</head>';
            xml += '<body  size="custom" width="279.4mm" height="241.3mm">';

            xml += '<table cellpadding="0" cellspacing="0" width="100%">'
            xml += '<tr>';
            xml += '<td style="font-size:14pt; font-weight:bold; align:center;"><u>FAKTUR PENJUALAN</u></td>'
            xml += '</tr>';
            ...
            xml += '<tr>';
            xml += '<td style="font-size:14; font-weight:bold">'+legalName+'</td>'
            xml += '<td style="">No. Faktur </td>'
            xml += '<td style="">:'+tranId+'</td>'
            xml += '</tr>';

            xml += '<tr>';
            xml += '<td style="font-size:14;">'+addres+'</td>'
            xml += '<td style="">Tgl. Faktur </td>'
            xml += '<td style="">:'+tranDate+'</td>'
            xml += '</tr>';

            xml += '<tr>';
            xml += '<td style="font-size:14; font-weight:bold"></td>'
            ...
            xml += '<table width="100%" style="font-size:11pt; table-layout:fixed; padding:1mm; border-collapse:collapse; border-spacing: 0;">'
            xml += '<tr>';
            ...
            xml += '<tr>';
            xml += '<td style="font-size:11pt; font-weight:bold; align:center; border:1px solid black; border-right:none;">No</td>'
            xml += '<td style="font-size:11pt; font-weight:bold; align:center; border:1px solid black; border-right:none;">Kode</td>'
            xml += '<td style="font-size:11pt; font-weight:bold; align:center; border:1px solid black; border-right:none;">Nama Barang</td>'
            xml += '<td style="font-size:11pt; font-weight:bold; align:center; border:1px solid black; border-right:none;">Harga Satuan</td>'
            xml += '<td style="font-size:11pt; font-weight:bold; align:center; border:1px solid black; border-right:none;">QTY</td>'
            xml += '<td style="font-size:11pt; font-weight:bold; align:center; border:1px solid black; border-right:none;">Satuan</td>'
            xml += '<td style="font-size:11pt; font-weight:bold; align:center; border:1px solid black; border-right:none;">Disc[%]</td>'
            xml += '<td style="font-size:11pt; font-weight:bold; align:center; border:1px solid black;">Jumlah</td>'
            xml += '</tr>';
    ...
    function getPOItem(context, ifRec, soId, employeeName){
        ...
        if(itemCount > 0){
            ...
            xml += "<td colspan='8'>"
                ...
                xml += "<tr>"
                xml += "<td style='border-top:1px solid black;'></td>"
                xml += "<td style='align:center; border-top:1px solid black;'>Fakturing,</td>"
                xml += "<td style='border-top:1px solid black;'></td>"
                xml += "<td style='align:center; border-top:1px solid black;'>Pelanggan,</td>"
                xml += "<td style='border-top:1px solid black;'></td>"
                xml += "<td style='align:center; border-top:1px solid black;'>Mengetahui,</td>"
                xml += "<td style='border-top:1px solid black;'></td>"
                ...
                xml += "<td style='align:center; border-bottom:1px solid black;'></td>"
                xml += "<td></td>"
                xml += "<td style='align:right; padding:1mm; border:1px solid black; border-top: none;'>Total</td>"
                xml += "<td style='align:right; padding:1mm;  border:1px solid black; border-top: none; border-left: none;'>"+removeDecimalFormat(subtotal)+"</td>"
                xml += "</tr>"
                ...
                xml += "<td style='align:center;'></td>"
                xml += "<td></td>"
                xml += "<td colspan='2'>Printed:"+formattedDateTime+"/"+employeeName+"</td>"
                xml += "</tr>"
