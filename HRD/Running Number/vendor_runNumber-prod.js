      ...
      if (context.type == context.UserEventType.CREATE) {
        ...
        switch (typeVendor) {
          ...
          case 'custompurchase_sol_pc_recoup':
            vendorPrefix = 'RPC_'
            break;
          case 'customrecord_sol_itq':
            vendorPrefix = 'ITQ_'
            break;
          case 'customrecord_sol_rfq':
            vendorPrefix = 'RFQ_'
            break;
          case 'customrecord_sol_rfp':
            vendorPrefix = 'PSMB_RFP'
            break;
          default:
        }
        ...
        vendorRunningNumbers.forEach(function(vendorRunningNumber) {
          ...
          if (vendorPrefix == 'RFQ_' || vendorPrefix == 'ITQ_' || vendorPrefix == 'PSMB_RFP') {
            vendorRec.setValue({
              fieldId: 'name',
              value: vendorNumber,
              ignoreFieldChange: true
