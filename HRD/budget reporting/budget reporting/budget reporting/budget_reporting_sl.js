  ...
  function onRequest(context) {
    ...
    if (contextRequest.method === "GET") {
      ...
      try {
        ...
        let budgetHeadApproveEmp = ccRec.getValue("custrecord_sol_dep_app");
        let budgetPreparerEmp_2 = ccRec.getValue("custrecord_sol_budget_bu_2");
        let budgetPreparerEmp_3 = ccRec.getValue("custrecordsol_budget_bu3");
        var departmentText = ccRec.getValue("name");

        if ((currentUser == budgetPreparerEmp || currentUser == budgetHeadApproveEmp || currentUser == budgetPreparerEmp_2 || currentUser == budgetPreparerEmp_3) || (currentUserRole == 1048 || currentUserRole == 1036 || currentUserRole == 1049)) {
